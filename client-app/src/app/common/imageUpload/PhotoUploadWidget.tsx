...
function PhotoUploadWidget({ uploadPhoto, loading }: Props) {
  ...
  return (
    <Grid>
      <Grid.Column width={4}>
        <Header sub color='teal' textAlign='center' content='Step 1 - Add Photo' />
        <PhotoWidgetDropzone setFiles={setFiles} />
      </Grid.Column>
      <Grid.Column width={1} />
      <Grid.Column width={4}>
        <Header sub color='teal' textAlign='center' content='Step 2 - Resize image' />
      ...
      <Grid.Column width={1} />
      <Grid.Column width={4}>
        <Header sub color='teal' textAlign='center' content='Step 3 - Preview & Upload' />
        {files && files.length > 0 && (
          <>
