...
/**Adding token to the API request */
...
axios.interceptors.response.use(
  async (response) => {
    await sleep(1000);
    //Using pagination result returned from API headers
...
const Activities = {
  list: (params: URLSearchParams) =>
    axios.get<PaginationResult<Activity[]>>('/activities', { params }).then(responseBody),
